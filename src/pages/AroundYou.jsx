...
const AroundYou = () => {
    ...
    useEffect(() => {
        ...
        axios.get('https://geo.ipify.org/api/v2/country?apiKey=at_863oK0u13sY2PWjwm5yYWuwokxYsu')
    ...
    if (isFetching && loading) return <Loader title= 'Looking for songs around you...' />

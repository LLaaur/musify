...
const TopChartCard = ({song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick}) => (
    <div className="w-full flex flex-row items-center font-semi-bold text-[#37fcff] hover:bg-[#4c426e] py-2 p-4 rounded-lg cursor-pointer mb-2">
      <h2 className="font-bold text-base text-white mr-3">{i + 1}.</h2>
      <div className="flex-1 flex flex-row justifi-between items-center">
